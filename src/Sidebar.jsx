...
const Sidebar = () => {
  return (
    <div className="h-screen w-20 bg-black text-white flex flex-col justify-between py-4">
      {/* Top Section - Logo */}
      ...
      <div className="flex flex-col items-center space-y-6">
        <SidebarIcon icon={<FaHome size="24" />} text="All Workspaces" to="/Workspace" />
        <SidebarIcon icon={<FaPlug size="24" />} text="Connectors" to="/connectors" />
        <SidebarIcon icon={<FaFolder size="24" />} text="Logs" to="/logs" />
        <SidebarIcon icon={<FaEllipsisH size="24" />} text="More" to="/more" />
      </div>
      </div>

      {/* Bottom Section - Notifications, Settings, Help */}
      <div className="flex flex-col items-center space-y-6 mb-4">
        <SidebarIcon icon={<FaBell size="24" className="text-pink-500" />} text="Notifications" badge={true} to="/notifications" />
        <SidebarIcon icon={<FaCog size="24" />} text="Settings" to="/settings" />
        <SidebarIcon icon={<FaQuestionCircle size="24" />} text="Help" to="/help" />
